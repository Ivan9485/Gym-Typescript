      ...
      >
        ...
        <div className="z-10 mt-32 md:basis-3/5 ">
          ...
          variants={{
            ...
            <p className="mt-8 text-sm">Transforma tu cuerpo y mente en nuestro gimnasio de primer nivel. Alcanza tus metas fitness mientras te rodeas de motivación y comunidad.
            </p>
          </motion.div>
          {/* ACTIONS */}
          ...
          initial="hidden" whileInView="visible"
          viewport={{once:true,amount:0.5}}
          transition={{delay:0.5, duration:0.90}}
          variants={{
            hidden: {opacity:0,x:-50},
            visible: {opacity:1, x:0},
          }}
