    ...
    <section id="contactus" className="mx-auto w-5/6 pt-24 pb-22">
      <motion.div onViewportEnter={()=>setSelectedPage(SelectedPage.ContactUs)}>
        ...
        variants={{
          ...
          <p className="my-5">Únete a una comunidad de individuos dedicados como tú. Comparte experiencias, consejos y logros, creando conexiones duraderas que hacen que cada entrenamiento sea aún más gratificante.
